 ...
 * File:   scatMat/DBXrayMaterial.cxx
 *
...
#include "DBXrayMaterial.h"

namespace scatterSystem
{

void
DBXrayMaterial::initMaterial()
  /*!
...
DBXrayMaterial::DBXrayMaterial() :
    MonteCarlo::DBMaterial()
  /*!
    Constructor
  */
{
...
DBXrayMaterial&
DBXrayMaterial::Instance() 
  /*!
    Singleton constructor
    \return DBXrayMaterial object
  */
{
  static DBXrayMaterial DObj;
  return DObj;
}
...
DBXrayMaterial::initMaterial()
   ...
   */
{
  ELog::RegMethod RegA("DBXrayMaterial","initMaterial");
...
void
DBXrayMaterial::setActive(const int M)
  /*!
...
bool
DBXrayMaterial::isActive(const int matN) const
  /*!
...
DBXrayMaterial::getMat(const int ID) const
  /*!
   ...
   */
{
  ELog::RegMethod RegA("DBXrayMaterial","getMat");
...
void
DBXrayMaterial::write(std::ostream& OX) const
  /*!
    Write everything out to the stream
    \param OX :: Output stream
  */
{
  ELog::RegMethod RegA("DBXrayMaterial","write");
